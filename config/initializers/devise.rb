...
Devise.setup do |config|
  ...
  config.mailer_sender = 'do-not-reply@g5search.com'
  ...
  # config.pepper = '8d901e67527b2a2c9f4b6ba83bccb2d7103e3c5ae24f811d3e35834d6c279404dbdf31b45efaaba8aa304f0f9441fcf1dc243c641a182a99460b2651da82a483'
  ...
  config.router_name = :g5_authenticatable

  # When using omniauth, Devise cannot automatically set Omniauth path,
  # so you need to do it manually. For the users scope, it would be:
  config.omniauth_path_prefix = '/g5_auth/users/auth'
end
